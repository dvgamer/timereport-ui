...
// --Script Check File ZIP ค้างที่ TFileTransUp@POSGW (total)
// SELECT COUNT(*) nTotal FROM POSGW..TFileTransUp a WITH(NOLOCK)
// WHERE a.sStatus IN (3,5)
// UNION ALL SELECT COUNT(*) FROM POSGW..TFileTransUp a WITH(NOLOCK)
...
// UNION ALL SELECT 'OtherFile', COUNT(1) FROM POSGW..TFileTransUp a WITH(NOLOCK)
...
// SELECT 'Not Sale', a.nStartDate,COUNT(1) FROM POSGW..TFileTransUp a WITH(NOLOCK)
// WHERE a.sStatus != 0 AND a.sZIPFileName NOT LIKE 'actualsale%' AND sZIPFileName NOT LIKE 'T1CSaleMember%'
// GROUP BY a.nStartDate
// ORDER BY a.nStartDate
// SELECT 'Sale', a.nStartDate,COUNT(1) FROM POSGW..TFileTransUp a WITH(NOLOCK)
// WHERE a.sStatus != 0 AND (a.sZIPFileName LIKE 'ActualSale%' OR sZIPFileName LIKE 'T1CSaleMember%')
// GROUP BY a.nStartDate
// ORDER BY a.nStartDate
